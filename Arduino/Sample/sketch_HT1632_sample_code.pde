...
void loop () {
  ...
  HT1632.clear();
  int wd = HT1632.getTextWidth("Hello, how are you?", FONT_5X4, FONT_5X4_WIDTH, FONT_5X4_HEIGHT);
  HT1632.drawText("Hello, how are you?", OUT_SIZE - i, 1, FONT_5X4, FONT_5X4_WIDTH, FONT_5X4_HEIGHT);
  i = (i+1)%(wd + OUT_SIZE);
  */
